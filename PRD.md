...
9. Режим видимости файлов — переменная окружения. По умолчанию
   **приватный**: скачивание только по короткоживущим подписанным
   ...
   выдача без входа. Файлы внутри продукта общие за входом.
...
11. Чеклист безопасности перед выводом продукта в продакшен, встроенный
...
8. Как автор проекта, выводящий из шаблона простой лендинг, я хочу
   включить публичный режим файлов одним решением в настройках, чтобы
   быстрый старт не требовал полного механизма входа.
...
- Прогон готовности (пункт 8) — наоборот, часть объёма итерации 2: он
