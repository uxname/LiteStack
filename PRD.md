...
- Проверка «replay вне бандла» — одноразовое доказательство + команда в
  ...
  ловит аудит.
- Все пять пунктов объёма внедряются одним заходом; приёмка итерации —
  проходящие проверки обеих сторон (backend и frontend) плюс ручная
  проверка запуском setup.sh и doctor.sh на свежем клоне.
