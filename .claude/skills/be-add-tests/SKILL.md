---
name: be-add-tests
description: "[backend] Write unit tests for an existing NestJS service, resolver, or controller in the project following its Vitest + NestJS Testing conventions."
---
