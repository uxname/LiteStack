...
description: "[litefront] Use this skill when the user adds UI text, labels, messages, or any user-facing strings that need to be internationalized. Also use when adding new i18n keys, translation strings, or working with Paraglide JS. Trigger phrases: \"add translation\", \"new i18n key\", \"paraglide\", \"i18n\", \"localization\"."
---
