---
name: fe-write-tests
description: "[frontend] Use this skill when the user asks to write tests, add test coverage, create unit tests, component tests, or E2E tests. Trigger phrases: \"write tests\", \"unit test\", \"component test\", \"e2e test\", \"playwright test\", \"vitest\"."
---
