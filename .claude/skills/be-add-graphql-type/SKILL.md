---
name: be-add-graphql-type
description: "[backend] Add a new GraphQL ObjectType, InputType, or Enum to the project following its code-first (NestJS + Mercurius) conventions."
---
...
1. `cd backend`
2. Read and follow `.agents/skills/add-graphql-type/SKILL.md` **exactly** — it is the source of truth.
