---
name: fe-add-gql
description: "[frontend] Use this skill when the user asks to add a GraphQL query, mutation, or subscription, fetch data from the API, or work with GraphQL operations. Trigger phrases: \"add graphql query\", \"add mutation\", \"add subscription\", \"graphql codegen\"."
---
