...
description: "[litefront] Use this skill when the user asks to protect a route, add authentication to a page, restrict access to authenticated users, or work with OIDC/OAuth auth context. Trigger phrases: \"protect route\", \"auth guard\", \"restricted page\", \"protected route\"."
---
