...
description: "[litefront] Use this skill to move code between FSD layers, safely rename a slice, or completely delete an FSD module (feature, entity, widget). Trigger phrases: \"migrate fsd\", \"move to feature\", \"rename slice\", \"delete entity\", \"remove feature\", \"refactor layer\"."
---
