---
name: fe-new-page
description: "[litefront] Use this skill when the user asks to create a new page, add a new route, or add a new screen to the application. Trigger phrases: \"new page\", \"new route\", \"add route\"."
---
...
1. `cd litefront`
2. Read and follow `.agents/skills/new-page/SKILL.md` **exactly** — it is the source of truth.
