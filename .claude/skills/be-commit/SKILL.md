---
name: be-commit
description: "[liteend] Create a git commit with all unstaged changes. Use this skill whenever the user asks to commit, make a commit, save changes to git, or says something like \"commit this\", \"commit all changes\". Always runs npm run check before committing and fixes any errors found."
---
