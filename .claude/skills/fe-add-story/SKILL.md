---
name: fe-add-story
description: "[litefront] Use this skill when the user asks to add a Ladle story, create a storybook story, document a component visually, or add component examples. Trigger phrases: \"add story\", \"create story\", \"component story\", \"ladle story\"."
---
