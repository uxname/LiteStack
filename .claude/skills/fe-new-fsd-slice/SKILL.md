---
name: fe-new-fsd-slice
description: "[litefront] Use this skill when the user asks to create a new FSD slice, add a new feature, entity, widget, or shared module, or when scaffolding any new architectural unit in the project. Trigger phrases: \"new feature\", \"new entity\", \"new widget\", \"new fsd slice\", \"scaffold slice\"."
---
...
1. `cd litefront`
2. Read and follow `.agents/skills/new-fsd-slice/SKILL.md` **exactly** — it is the source of truth.
